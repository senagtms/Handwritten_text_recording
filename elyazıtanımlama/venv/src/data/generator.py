"""
Verilerle eğitim  / test sağlamak için generator işlevlerini kullanır.
Görüntü işleme ve metin anında her zaman oluşturulur ve oluşturulmalıdır
...
class DataGenerator():
    """veri akışı ve generator sınıfı"""
    ...
    def next_train_batch(self):
        """Train bölümünden bir sonraki küme alınır (yield)"""
...
class Tokenizer():
    """ charset / sözlük belirteçlerin  ve fonksiyonların özellikleri"""
    ...
    def remove_tokens(self, text):
        """Belirteçleri (PAD) metinden Kaldır"""
