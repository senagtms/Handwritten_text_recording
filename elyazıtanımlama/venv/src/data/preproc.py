"""
Data preproc  işlevleri:
    adjust_to_see: Daha iyi görselleştirmek için görüntüyü ayarlar (Döndürür ve aktarır)
    augmentation: görüntülerin bir listesine varyasyonları uygular
    normalization: görüntülerde normalleştirme ve varyasyonları uygular(gerekirse)
    preprocess: ön işlem için ana işlev.
        Resmi yapma:
            illumination_compensation: aydınlatma düzenleme uygulama
            remove_cursive_style: görüntüden el yazı stilini kaldır (gerekirse)
            sauvola: sauvola binarizasyonunu Uygula
    text_standardize: ön işlem ve cümle standartları
    generate_multigrams: cümlenin n gramını oluştur
...
def adjust_to_see(img):
    """Görüntü görselleştirmeye döndürme ve aktarma (cv2 yöntemi veya jupyter notebook)"""
...
def augmentation(imgs,
                 ...
                 dilate_range=1,
                 erode_range=1):
    """Görüntülerin bir listesine varyasyonlar uygular
    (döndürme, genişlik ve yükseklik kayması, ölçek, aşındırmak, büyütme)"""
...
def normalization(imgs):
    """Görüntülerin listesini normalleştir"""
...
def preprocess(img, input_size):
    """Ölçek yeniden boyutlandırmak için `input_size` ile işlem yapılır"""
...
def illumination_compensation(img):
    """Metin görüntüsü için aydınlatma telafisi tekniği"""
...
def remove_cursive_style(img):
    """"Deslanting algoritması ile görüntüden el yazma stilini kaldırır"""
...
"""
Deepspell tabanlı metin temizleme işlemi
...
def text_standardize(text):
    """Noktalama işaretleri etrafında boşluk düzenleme / ekleme"""
...
def generate_multigrams(sentence):
    """
  Cümlenin n gramını oluşturma
    yani.:
    orijinal cümle: kodu severim .
        > cümle 1: ben gibi
        > cümle 2: kodu severim .
        > cümle 3: gibi
        > cümle 4: kod gibi .
        > cümle 5: kod .
    """
